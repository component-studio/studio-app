<div x-show="tab=='code'" class="w-full relative border-t border-zinc-200 p-5">
    <div class="bg-zinc-50 border border-zinc-100 rounded-md font-mono p-5 relative">
        <pre><code class="language-html" id="codeblock">{{ $code }}</code></pre>
        <div x-data="{
                copyNotification: false,
                copyToClipboard() {
                    let copyText = document.getElementById('codeblock').innerText;
            ...
            }" class="absolute right-0 top-0 mt-3 mr-3 z-20 flex items-center">
